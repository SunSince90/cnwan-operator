...
CN-WAN Operator works with objects defined the [main documentation](#TODO: Create the main documentation) and you can read them even with [manual operations](#TODO create manual operations guide).
