...
Please take a look at the [main documentation](../service_registry.md) to learn more about them.
...
CN-WAN Operator works with objects defined the [main documentation](../service_registry.md) and you can read them even with manual operations](./interact.md).
